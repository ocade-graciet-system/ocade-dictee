...
const settingUpdaters: {
  ...
  mute_others_while_recording: (value) =>
    commands.changeMuteOthersWhileRecordingSetting(value as boolean),
  comm_mute_shortcut: (value) =>
    commands.changeCommMuteShortcutSetting(value as string),
  comm_mute_mode: (value) =>
    commands.changeCommMuteModeSetting(value as CommMuteMode),
