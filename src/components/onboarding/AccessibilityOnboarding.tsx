  ...
  return (
    <div className="h-screen w-screen flex flex-col p-6 gap-6 items-center justify-center">
      ...
      <div className="max-w-md w-full flex flex-col items-center gap-4">
        ...
        {/* OCADE — Accès direct : la transcription de fichier ne requiert aucune
            permission (ni micro ni accessibilité). On autorise donc l'entrée
            dans l'app sans rien accorder ; la dictée redemandera ces
            autorisations au moment où elle en a besoin. */}
        <button
          onClick={onComplete}
          className="text-sm text-text/50 hover:text-text/80 underline transition-colors mt-2"
        >
          {t("onboarding.permissions.continueWithout", {
            defaultValue:
              "Continuer sans autoriser — accéder à la transcription de fichier",
          })}
        </button>
      </div>
    </div>
