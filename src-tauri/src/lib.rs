...
use managers::file_history::FileHistoryManager;
...
fn initialize_core_logic(app_handle: &AppHandle) {
    ...
    let file_history_manager = Arc::new(
        FileHistoryManager::new(app_handle).expect("Failed to initialize file history manager"),
    );
...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::change_mute_others_while_recording_setting,
            shortcut::change_comm_mute_shortcut_setting,
            shortcut::change_comm_mute_mode_setting,
            ...
            commands::audio::is_transcribing,
            ...
            commands::file_transcription::transcribe_url,
