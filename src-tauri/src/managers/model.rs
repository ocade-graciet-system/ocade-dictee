...
impl ModelManager {
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        // OCADE fork: French-distilled Whisper large-v3, **dec2** variant (2
        ...
        // French-only, so the vocab overstates what the model actually
        // transcribes well. Don't "fix" it to the full Whisper language list.
        available_models.insert(
            DEFAULT_FR_MODEL_ID.to_string(),
            ModelInfo {
                id: DEFAULT_FR_MODEL_ID.to_string(),
                name: "Whisper Distil French (dec2)".to_string(),
                description: "Optimized for French. Fastest distil variant.".to_string(),
                filename: "whisper-distil-fr-dec2-q5_0.bin".to_string(),
                source: ModelSource::Url {
                    url: "https://huggingface.co/bofenghuang/whisper-large-v3-french-distil-dec2/resolve/main/ggml-model-q5_0.bin".to_string(),
                    sha256: Some(
                        "e41b30e80d6c24b195c0ead3f78475019d1e3ab84db6794da7e0fb8f11d6d977"
                            .to_string(),
                    ),
                },
                size_mb: 512,
        ...
        // OCADE fork: the heavier **dec16** variant (16 decoder layers — the most
        // accurate distil, closest to full large-v3). Kept in the list as the
        // precision-first alternative to the default dec2, so an existing install
        // that already downloaded it keeps working untouched.
        available_models.insert(
            "whisper-distil-fr-dec16-q5_0".to_string(),
            ModelInfo {
                id: "whisper-distil-fr-dec16-q5_0".to_string(),
                name: "Whisper Distil French (dec16)".to_string(),
                description: "Optimized for French. Most accurate distil variant.".to_string(),
                filename: "whisper-distil-fr-dec16-q5_0.bin".to_string(),
                source: ModelSource::Url {
                    url: "https://huggingface.co/bofenghuang/whisper-large-v3-french-distil-dec16/resolve/main/ggml-model-q5_0.bin".to_string(),
                    sha256: Some(
                        "a804330f5cd369fb7447ad2935eb7bf5b1d628ba246a067255ac70775df720e4"
                            .to_string(),
                    ),
                },
                size_mb: 755,
