...
**Version minimale :** Windows 10 (64 bits). **Fichier :** `OCADE Dictée_…_x64-setup.exe` — seule version publiée ; elle fonctionne aussi sur Windows ARM, via émulation.
...
**Installation silencieuse (support) :** `"OCADE Dictée_…_x64-setup.exe" /S`
...
- L'application démarre avec Windows, masquée ; son icône se trouve dans la zone de notification (près de l'horloge, parfois sous la flèche **^**). **Réglages** affiche la fenêtre des paramètres.
